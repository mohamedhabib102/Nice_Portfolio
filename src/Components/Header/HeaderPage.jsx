      ...
      <header className="header-container" >
        <div className='coustom-container'>
          ...
          <div className='icon-title icon-container'>
            <div className={`icon relative w-[30px] h-[20px] cursor-pointer
            ${isActive ? "show" : " "}`
          } onClick={() => {
              checkActive()
            }}>
        ...
        <li>
          ...
          >
            ...
            <div className='title fs-1'><span className="c-main-color font-bold">M</span>Habib</div>
          </div>
          <div className='content p-3 text-center'>
            <span className="fs-2 font-bold of-span-content text-[20px]">Hello World!</span>
            <h3 className="text-[55px] max-[767px]:text-[35px]">I'm Mohamed Habib</h3>
            <p className="text-[17px] uppercase m-0 max-[767px]:text-[13px]">Front End Developer React.js</p>
          </div>
          <div className='links'>
